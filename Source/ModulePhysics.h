...
public:
	...
	PhysBody* CreateRectangle(fPoint pos, int width, int height, GameObject* gameObject = nullptr, b2BodyType colType = b2BodyType::b2_dynamicBody, short filterLayer = 0x0001);
	PhysBody* CreateRectangleSensor(fPoint pos, int width, int height, GameObject* g = nullptr, b2BodyType colType = b2BodyType::b2_dynamicBody, short filterLayer = 0x0001);
